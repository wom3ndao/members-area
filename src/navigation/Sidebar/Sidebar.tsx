          ...
          <div className="sidebar-main">
            ...
            {!isShowDao && (
              <div className="sidebar-links">
                <SidebarLink exact={!pathname.includes("dashboard")} to={"/"} title={t("DASHBOARD")} icon="dashboard" />
                <SidebarLink exact={false} to={"/mein-nft"} title={"Mein NFT"} icon="wallet" />
                <SidebarLink exact={false} to={"/collection"} title={"Collection"} icon="folder" />
                <SidebarLink exact={false} to={composeDaoLink("/governance")} title={t("GOVERNANCE")} icon="vote" />
                <SidebarLink
                  exact={false}
