    ...
    <SettingsMenuContainer>
      <div className="language-block" onClick={onLanguageOpen}>
        ...
        <div className="language-pick">
          <img className="language-pick__flag" src={language.flagSrc} alt="flag" />

          <p className="text-md font-semibold">{language.language}</p>
        </div>
      </div>

      <Switch className="theme-toggle" label={t("DARK_THEME")} value={isDarkTheme} onChange={onChangeTheme} />
    </SettingsMenuContainer>
  );
}
